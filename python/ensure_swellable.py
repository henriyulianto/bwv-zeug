...
def modify_svg_paths(svg_content):
    ...
    for anchor_element in musical_anchors:
        ...
        for path_element in child_paths:
            ...
            if transform_value:
                ...
                # Move transform up
                new_group.set('transform', transform_value)

                # Clean path element and add to group
                # Remove original transform
                path_element.attrib.pop('transform', None)
    ...
    xml_string = ET.tostring(
        svg_root, encoding='unicode', xml_declaration=False)
...
def process_svg_file(input_path, output_path):
    ...
    try:
        ...
        modified_svg_content, transformation_summary = modify_svg_paths(
